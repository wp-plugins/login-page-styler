...
function lps_login_background_color(){
    ...
    echo '<style>body { background-color: ' . get_option( 'lps_login_background_color' ) . '!important; } </style>';
}
...
function lps_login_form_border_radius(){
	...
	echo '<style> .login form{ border-radius:'.get_option('lps_login_form_border_radius' ).';}</style>';
}

function lps_login_label_size(){

	echo '<style> .login label { font-size:' .get_option('lps_login_label_size').'; font-family:'.get_option('lps_login_form_label_font').';}</style>';
}


function lps_login_remember_label_size(){

	echo '<style>  .login form .forgetmenot label {font-size:'.get_option('lps_login_remember_label_size').';} </style>';
}
...
function lps_login_form_input_feild_border_radius(){
	...
	echo '<style> .login form .input {border-radius:'.get_option('lps_login_form_input_feild_border_radius').';}</style>';
}
...
function lps_login_button_border_radius(){
	...
	echo '<style> .login .button-primary{ border-radius:'.get_option('lps_login_button_border_radius').'; } </style>';
}
...
function lps_body_bg_img(){
	...
	background-repeat: '.get_option('lps_login_bg_repeat').'; display:block;   background-attachment: fixed;!important} </style>';
}
...
function lps_login_logo(){
	...
	{	
	   echo '<style> .login h1 a{ display:block; background-size:'.get_option('lps_login_logo_width').','.get_option('lps_login_logo_height').';  background-image:url('.get_option('lps_login_logo').');} </style>';
    }
...
function lps_login_logo_width(){
    ...
    {
	   echo '<style> .login h1 a{ width:'.get_option('lps_login_logo_width').';}</style>';
    }
}
...
function lps_login_logo_height(){
    ...
    {
	   echo '<style> .login h1 a{ height:'.get_option('lps_login_logo_height').';}</style>';
    }
}
...
function lps_login_form_border_style(){
	...
	echo '<style> .login form{border-style:'.get_option('lps_login_form_border_style').';
     border-width:'.get_option('lps_login_form_border_size').';
...
function lps_login_form_input_border_style(){
	...
	echo '<style> .login form .input{border-style:'.get_option('lps_login_form_input_border_style').';
	 border-width:'.get_option('lps_login_form_input_border_size').';}</style>';
}
