...
function lps_login_label_size(){
	...
	echo '<style> .login label { font-size:' .get_option('lps_login_label_size').';}</style>';
}
...
function lps_login_form_border_color(){

	echo '<style> .login form(border-color:'.get_option('lps_login_form_border_color').';) </style>';
}
