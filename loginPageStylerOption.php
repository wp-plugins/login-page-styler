           ...
           <table class="form-table">
		    ...
		    <tr valign="top">
			  ...
			  <td><label for="lps_login_logo_width">
				  ...
				  <p class="description"><?php _e( 'Enter logo width with px eg:150px. <b>Premium Version <a href="http://web-settler.com/login-page-styler/">Unlock Here</a> </b>'); ?></p>
				 </lable>
			 </td>
		    </tr>
		    ...
		    <tr valign="top">
			  ...
			  <td><label for="lps_login_logo_height">
				  ...
				  <p class="description"><?php _e( 'Enter logo height with px eg:100px .<b>Premium Version <a href="http://web-settler.com/login-page-styler/">Unlock Here</a> </b>'); ?></p>
				 </lable>
			 </td>0
		    </tr>
           ...
           <table class="form-table">
			...
			<tr valign='top'>
				...
				<td><label for='lps_login_label_size'>
					<input type='text'  id='lps_login_label_size' name='lps_login_label_size' size='12' value='<?php echo get_option('lps_login_label_size'); ?>' /> 
			...
			<tr valign='top'>
				...
				<td><label for='lps_login_remember_label_size'>
					<input  size='12' type='text'  id='lps_login_remember_label_size' name='lps_login_remember_label_size' value='<?php echo get_option('lps_login_remember_label_size'); ?>'  disabled/> 
			...
			<tr valign="top">
			  ...
			  <td>
			  	<label for="lps_login_form_border_size">
			  	  <input size='12' type='text' id='lps_login_form_border_size' name='lps_login_form_border_size' value='<?php echo get_option('lps_login_form_border_size'); ?>' />	
			  	  <p class="description"><?php _e('Add border size with px ,Example : 2px');?></p>
			  	</label>
			...
			<tr valign='top'>
				...
				<td><label for='lps_login_form_border_radius'>
					<input size='12' type='text' id='lps_login_form_border_radius' name='lps_login_form_border_radius' value='<?php echo get_option('lps_login_form_border_radius' ); ; ?>'/>
			...
			<tr valign="top">
			  ...
			  <td>
			  	<label for="lps_login_form_input_border_size">
			  	  <input size='12' type='text' id='lps_login_form_input_border_size' name='lps_login_form_input_border_size' value='<?php echo get_option('lps_login_form_input_border_size'); ?>' />	
			  	  <p class="description"><?php _e('Add Input field border size with px eg: 2px');?></p>
			  	</label>
			...
			<tr valign='top'>
				...
				<td><label for='lps_login_form_input_feild_border_radius'>
					<input size='12' type='text' id='lps_login_form_input_feild_border_radius' name='lps_login_form_input_feild_border_radius' value='<?php echo get_option('lps_login_form_input_feild_border_radius' ); ;?>'disabled/>
...
<div id="headings-data">
			...
			<tr valign='top'>
				...
				<td><label for='lps_login_button_border_radius'>
					<input size='12' type='text' id='lps_login_button_border_radius' name='lps_login_button_border_radius' value='<?php echo get_option('lps_login_button_border_radius' ); ; ?>' />
